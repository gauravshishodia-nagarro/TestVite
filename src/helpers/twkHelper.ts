...
export const useAutoLogin = () => {
    ...
    const login = async (twkToken: string, userDetails: Omit<ValidateTawakkalnaTokenPayload, 'twkToken'>) => {
      let appToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiODkzNTE2ZTAtM2M4OS0xMWYxLTlmZjUtYmZlNTViNmY0NDA5IiwibmFtZSI6ImdhdXJhdiB0ZXN0In0sImlhdCI6MTc3NjY2OTY4OCwiZXhwIjoxNzgxODUzNjg4fQ.99ATK-zyn7CCn61Elv_Qot0VFmq4E_3G7fVD78vqnPw';
      // let appToken = '';
